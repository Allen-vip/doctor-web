<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="devices" highlight-current-row
                  v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            <el-table-column type="selection" width="35" align="center">
            </el-table-column>
            <el-table-column type="index" width="60" align="center">
            </el-table-column>
            <el-table-column prop="buildingNum" label="楼栋" width="120" sortable align="center">
            </el-table-column>
            <el-table-column prop="unitNum" label="单元" width="120" sortable align="center">
            </el-table-column>
            <el-table-column prop="aliaId" label="设备ID" width="150" sortable align="center">
            </el-table-column>
            <el-table-column prop="type" label="类型" width="120" :formatter="formatType" sortable align="center">
            </el-table-column>
            <el-table-column prop="macAddr" label="MAC地址" width="180" sortable align="center">
            </el-table-column>
            <el-table-column prop="connState" label="在线状态" width="180" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column property="accountNickName" label="账号" width="120" sortable align="center" v-if="isAdmin===1">
            </el-table-column>
...
<script>
    ...
    import {getDeviceListPage, removeDevice, batchRemoveDevice, updateDevice, addDevice} from '../../api/api';
                ...
                getDeviceListPage(para).then((res) => {
                    ...
                    this.devices.forEach( device => {
                        ...
                        if(device.connOnline == 1) {
                            ...
                            device.connState += ' | 登录时间：' +
                                util.formatDate.format(new Date(device.connBegin * 1000), 'yyyy-MM-dd hh:mm:ss')
