<template>
  ...
  >
    ...
    <el-form-item label="活体检测" prop="liveDetectOn">
      <el-switch v-model="cfgEditForm.liveDetectOn"></el-switch>
    </el-form-item>
    ...
    <el-form-item label="识别数据本地保存时间（天）" prop="regzSaveLocalTime">
      <el-input-number v-model="cfgEditForm.regzSaveLocalTime" :min="30" :max="365"></el-input-number>
    </el-form-item>
    ...
    <el-form-item label="关屏关识别时间（秒）" prop="regzOffTime">
      <el-input-number v-model="cfgEditForm.regzOffTime" :min="1" :max="86400"></el-input-number>
    </el-form-item>
    ...
    <el-form-item label="关门超时报警时间（秒）" prop="doorCloseAlarmTime">
      <el-input-number v-model="cfgEditForm.doorCloseAlarmTime" :min="10" :max="60"></el-input-number>
    </el-form-item>
        ...
        if (this.cfgEditForm.getAgain == true) {
          setTimeout(() => {
            apiGetDevcfgByDevId(para).then(res => {
              ...
              this.cfgEditForm.regzSaveLocalTime =
                this.devcfg.regzSaveLocalTime / 24;
    ...
    getDevices: function() {
      ...
      getDeviceListPage(para).then(res => {
        ...
        this.devices.forEach(device => {
          ...
          if (this.isAdmin === 1) {
            device.fullName =
              device.fullName + "｜账号：" + device.accountNickName;
          }
        });
          ...
          this.$confirm("确认提交吗？", "提示", {})
            .then(() => {
              ...
              apiUpdateDevcfg(para).then(res => {
                ...
                this.devcfg.regzSaveLocalTime =
                  this.cfgEditForm.regzSaveLocalTime * 24;
                //NProgress.done();
                this.$message({
                  message: "提交成功",
                  type: "success"
